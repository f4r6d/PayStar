                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="w-4 p-4">
                                ...
                                <td class="w-32 p-4">
                                    <img src="{{ url('storage/'. ($product->image ?? '/default_image')) }}" alt="{{$product->name }}">
                                </td>
                ...
                {{$product->description}}
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <form action="{{ route('products.destroy', $product) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <input onclick="return confirm('Delete {{ $product->name }}')" class="font-medium text-red-600 dark:text-red-500 hover:underline" type="submit" value="Remove">
                                    </form>
                                </td>
